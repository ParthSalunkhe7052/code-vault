...
DODO_ENVIRONMENT = os.getenv(
    "DODO_ENVIRONMENT", "test_mode"
)  # "test_mode" or "live_mode"

# Dodo Product IDs (Subscriptions)
DODO_PRODUCT_PRO = os.getenv("DODO_PRODUCT_PRO", "pdt_0NXJeTGGO7TcoXs3mzf3C")
DODO_PRODUCT_ENTERPRISE = os.getenv(
    "DODO_PRODUCT_ENTERPRISE", "pdt_0NXJetytBeAnE4cZ6BX9Y"
)
...
if ENVIRONMENT == "production":
    ...
    if not DODO_WEBHOOK_SECRET:
        config_issues.append(
            "DODO_WEBHOOK_SECRET must be set in production for secure webhooks!"
        )
...
PRICING_CONFIG = {
    ...
    "enterprise": {
        ...
        "price": 99,
        "currency": "USD",
        "product_id": DODO_PRODUCT_ENTERPRISE,
        "features": [
            "Unlimited Licenses",
            "50 Cloud Builds/mo",
            "Priority Support",
