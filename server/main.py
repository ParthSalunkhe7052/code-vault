...
from routes.dodo_routes import router as dodo_router
...
from routes.dodo_webhook import router as dodo_webhook_router
...
app.include_router(dodo_webhook_router)
