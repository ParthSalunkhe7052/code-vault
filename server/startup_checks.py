...
def run_startup_checks():
    ...
    if not os.getenv("STRIPE_WEBHOOK_SECRET"):
        if ENVIRONMENT == "production":
            ...
            logger.warning("STRIPE_WEBHOOK_SECRET is missing. Webhooks signatures might not be verified properly in dev mode.")
    ...
    if not os.getenv("STRIPE_PRICE_ENTERPRISE"):
         logger.warning("STRIPE_PRICE_ENTERPRISE is not set. Enterprise plan might not work.")
