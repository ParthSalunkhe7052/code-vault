...
class CodeVaultClient:
    def __init__(self, license_key: str, server_url: str, public_key_pem: Optional[str] = None):
    ...
    def _verify_signature(self, result: Dict[str, Any]) -> bool:
        ...
        if not self.public_key_pem or not HAS_CRYPTO:
            return True # Skip verification if no key or library
