...
def get_api_base() -> str:
    ...
    Priority: LW_API_URL env var > config.json > default
    """
    # Environment variable takes priority (for testing and overrides)
    ...
    return config.get("api_url", DEFAULT_API_BASE)
