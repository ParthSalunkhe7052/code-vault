...
import { License, HardwareBinding } from '../../types/api';
...
const BindingsModal: React.FC<BindingsModalProps> = ({
    isOpen,
    onClose,
    license,
    bindings,
...
const ResetStatusBanner: React.FC<any> = ({ resetStatus, bindings, resetting, onResetHwid }) => (
...
const BindingsList: React.FC<{ bindings: HardwareBinding[]; onRemoveBinding: (id: string) => void }> = ({ bindings, onRemoveBinding }) => (
...
const BindingCard: React.FC<{ binding: HardwareBinding; onRemove: (id: string) => void }> = ({ binding, onRemove }) => (
