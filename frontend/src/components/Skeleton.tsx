...
const Skeleton: React.FC<SkeletonProps> = ({ className = '', style }) => (
    <div className={`animate-pulse bg-white/5 rounded ${className}`} style={style} />
);
...
export const SkeletonText: React.FC<{ width?: string; height?: string }> = ({ width = 'w-24', height = 'h-4' }) => (
