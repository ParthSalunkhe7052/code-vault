...
import { Upload, FolderTree, Settings, Shield, Hammer, CheckCircle } from 'lucide-react';
...
const WizardSidebar: React.FC<WizardSidebarProps> = memo(({ currentStep, completedSteps = [] }) => {
    const steps = [
        { 
            id: 1, 
            name: 'Upload', 
