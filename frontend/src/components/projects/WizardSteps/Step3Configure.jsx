            ...
            <div className="bg-white/5 rounded-xl border border-white/10 overflow-hidden">
                ...
                {showAdvanced && (
                    <div className="p-4 border-t border-white/10 space-y-6">
                        ...
                        {/* Offline Lease Toggle - Available for BOTH Python and Node.js */}
                        <div className="bg-white/5 rounded-lg p-3">
                            <label className="flex items-center gap-3 cursor-pointer">
                                <input
                                    type="checkbox"
                                ...
                                />
                                <div className="flex-1">
                                    <span className="text-sm font-medium text-white">Enable Offline Lease</span>
                                    <p className="text-xs text-slate-500">Allow 24-hour offline access after successful license validation</p>
                                </div>
                                {enableLease && (
