...
import { Timer, Key, ArrowRight, Info, CheckCircle, AlertTriangle } from 'lucide-react';

interface BrandingNoticeProps {
    isPro: boolean;
    canRemoveBranding: boolean;
}

const BrandingNotice: React.FC<BrandingNoticeProps> = memo(({ isPro, canRemoveBranding }) => {
...
interface Step4LicenseProps {
    ...
    setProtectionMode: (mode: string) => void;
    demoMode: boolean;
    setDemoMode: (enabled: boolean) => void;
    demoDuration: number;
    setDemoDuration: (duration: number) => void;
    isPro?: boolean;
    canRemoveBranding?: boolean;
}

const Step4License: React.FC<Step4LicenseProps> = memo(({
    ...
    const handleDemoDurationChange = useCallback((value: string) => {
