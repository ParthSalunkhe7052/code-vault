...
interface ExpiringLicenseProps {
    license: {
...
const ExpiringLicense: React.FC<ExpiringLicenseProps> = ({ license }) => {
    const daysUntil = Math.ceil((new Date(license.expires_at).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24));
