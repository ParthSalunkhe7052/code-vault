...
const UsageBar: React.FC<UsageBarProps> = ({ label, current, max, color = "bg-violet-500" }) => {
...
const UsageStats: React.FC<UsageStatsProps> = ({ projectCount = 0, licenseCount = 0 }) => {
    ...
    return (
        <div className="glass-card p-6">
            ...
            <UsageBar 
                ...
                color={projectCount >= limits.maxProjects && limits.maxProjects !== Infinity && limits.maxProjects !== -1 ? "bg-red-500" : "bg-violet-500"}
            />
            ...
            <UsageBar 
                ...
                color={licenseCount >= limits.maxLicenses && limits.maxLicenses !== Infinity && limits.maxLicenses !== -1 ? "bg-red-500" : "bg-emerald-500"}
            />
