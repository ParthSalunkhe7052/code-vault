...
const QuickStatsBar: React.FC<QuickStatsBarProps> = ({ projectCount, licenseStats, validationStats }) => {
    const successRate = validationStats?.last_24h?.total && validationStats.last_24h.total > 0
