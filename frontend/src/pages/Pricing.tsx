...
import { Check, X, Sparkles, Zap, Crown, ArrowRight, Loader2, LucideIcon } from 'lucide-react';
...
const Pricing: React.FC = () => {
    ...
    const tiers = [
        ...
        },
        {
            ...
            price: 39,
            period: 'month',
            description: 'For studios and high-volume deployments',
            icon: Crown,
            iconColor: 'from-amber-500 to-orange-500',
            features: [
                'Unlimited Projects',
                '5,000 Active Licenses',
                '100 Cloud Build Credits / month',
