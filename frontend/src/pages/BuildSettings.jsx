...
// ---------------------------------------------------------------------------
// Module-scope sub-components — defined outside BuildSettings so React does
// not recreate their identity on every parent render, avoiding unnecessary
// unmount/remount of children.
// ---------------------------------------------------------------------------
...
const SettingsInput = ({ label, description, value, onChange, placeholder }) => (
    <div className="py-2">
...
const SettingsSelect = ({ label, description, value, onChange, options }) => (
    <div className="py-2">
        <label className="text-cv-text font-medium block mb-1">{label}</label>
        {description && <p className="text-xs text-cv-text-muted mb-2">{description}</p>}
