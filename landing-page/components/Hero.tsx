...
import { ArrowRight, Terminal, Store, Globe } from 'lucide-react';
...
const Hero: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center pt-24 overflow-hidden bg-[#0B0C10]">
      ...
      {/* Optimized Background - CSS Radial Gradients */}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm animate-fade-in">
          ...
          <span className="text-xs font-medium text-green-200">New: Sell your tools globally</span>
        </div>

        {/* Heading */}
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 animate-slide-up">
          The Marketplace for<br />
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Desktop Software.</span>
        </h1>
        ...
        <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-slide-up [animation-delay:100ms]">
          Build with Python or Node.js. We handle compilation, licensing, payments, and delivery. 
          Stop sending zip files. Start building a business.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up [animation-delay:200ms]">
          <a href={`${APP_URL}/signup`} className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full bg-white px-8 font-medium text-black transition-all duration-300 hover:bg-gray-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900">
            <span className="mr-2">Start Selling Free</span>
        ...
        {/* Code/Terminal Preview - Seller Workflow */}
        <div className="relative w-full max-w-4xl mx-auto mt-10 rounded-xl overflow-hidden border border-white/10 shadow-2xl bg-[#0F1115] animate-slide-up [animation-delay:300ms]">
           <div className="flex items-center px-4 py-3 bg-[#16181D] border-b border-white/5">
              ...
              <div className="ml-4 text-xs text-gray-500 font-mono">codevault-cli — seller-mode</div>
           </div>
           <div className="p-6 text-left font-mono text-sm md:text-base leading-relaxed overflow-x-auto">
              ...
              <div className="flex">
                  ...
                  <span className="text-gray-400 ml-2">codevault publish ./scraper.py --price 49.00</span>
              </div>
              <div className="mt-2 text-slate-400">
                  <span className="text-blue-500">ℹ</span> Compiling to native binary (Nuitka)... <span className="text-green-500">Done</span><br/>
                  <span className="text-blue-500">ℹ</span> Creating store listing... <span className="text-green-500">Done</span><br/>
                  <span className="text-green-400">✔ Published!</span> <span className="text-slate-500">https://store.codevault.app/p/scraper-bot</span>
              </div>
              ...
              <div className="mt-6 flex">
                  <span className="text-green-400 mr-2">➜</span>
                  <span className="text-blue-400">~</span>
                  <span className="text-gray-400 ml-2">codevault earnings</span>
              </div>
               <div className="mt-2 text-slate-400">
                  <span className="text-gray-500">--------------------------------</span><br/>
                  <span className="text-white">Total Sales:</span>      <span className="text-green-400">$1,240.00</span><br/>
                  <span className="text-white">Pending Payout:</span>   <span className="text-yellow-400">$240.00</span><br/>
                  <span className="text-gray-500">--------------------------------</span><br/>
                  <span className="text-blue-500">ℹ</span> Next payout scheduled for Friday.
              </div>
